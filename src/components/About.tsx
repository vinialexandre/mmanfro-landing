      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-12 md:mb-16">
          <div ref={image.ref} className={`relative animate-fade-left ${image.isVisible ? 'visible' : ''}`}>
            <div className="relative w-full aspect-[4/5] max-w-xs sm:max-w-sm md:max-w-md mx-auto">
          ...
          <div ref={text.ref} className={`space-y-4 sm:space-y-6 animate-fade-right ${text.isVisible ? 'visible' : ''}`}>
            ...
            <p className="text-base sm:text-lg text-gray-700 leading-relaxed text-justify font-semibold">
